...
class FillingLoopParameterId(IntEnum):
	SINGLE_FILL = 1
	AUTO_FILL = 2
	PRESSURE_INPUT_TYPE = 3
	MINIMUM_PRESSURE = 4
	PRESSURE_HYST = 5
	FILLING_DURATION = 6
	PRESSURE_LOSS_ALARM_RESET = 7
	AUTO_FILL_COUNTER = 8
...
class TemperatureGeneratorParameterId(IntEnum):
	MAXIMUM_TEMPERATURE = 1
	MINIMUM_TEMPERATURE = 2
	DUMMY3 = 3
	MINIMUM_TEMPERATURE_RESTRICTION = 4
	ABSOLUTE_HYSTERESIS = 5
	HYSTERESIS_REDUCE_TIME = 6
	SECOND_STAGE_ON_DELAY = 7
	SECOND_STAGE_HYSTERESIS = 8
	DUMMY9 = 9
	DUMMY10 = 10
	PUMP_OFF_DELAY = 11
	STAGE_1_POWER = 12
	STAGE_2_POWER = 13
	ANALOG_STAGE_SIGNAL_TYPE = 14
	STAGE_MODULATION_SIGNAL = 15
	MIN_ON_TIME = 16
	MIN_OFF_TIME = 17
	SCHEDULE = 18
